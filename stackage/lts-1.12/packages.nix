# Generated by stackage2nix 0.5.0 from "/nix/store/5hv357jpjvwz6dk84fmcz1mj7agww772-stackage-lts/lts-1.12.yaml"
  ...
  "hspec-core" = callPackage
    ({ mkDerivation, ansi-terminal, async, base, deepseq
     ...
     mkDerivation {
       ...
       revision = "3";
       editedCabalFile = "120l2ic98z3ksr1nyv2a3wnnkbq7gcfv8kn9d95gqvgcgbjd6cbg";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
