# Generated by stackage2nix 0.6.0 from "/nix/store/hjyi9jjczpnkmjskxpdrx1bcjrxzm15a-stackage-lts/lts-1.12.yaml"
...
self: {
  ...
  "classy-prelude" = callPackage
    ({ mkDerivation, base, basic-prelude, bifunctors, bytestring
     ...
     mkDerivation {
       ...
       revision = "1";
       editedCabalFile = "1gwd3s3sp8qkqh04gzmh7j0x0w9vnz7z236vzsg7k2zycnxn1ij6";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "comonad" = callPackage
    ({ mkDerivation, base, containers, contravariant, directory
     ...
     mkDerivation {
       pname = "comonad";
       version = "4.2.4";
       sha256 = "0wycd7ir3bjrf9k1fh81jl09lk9s99fg8z25lwhb8bc70q50sab8";
       revision = "1";
       editedCabalFile = "17cayiisx83gjw5gqr9s7djy4r8ssrf1yrypknyvx6b7rh6k71yk";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "conduit-extra" = callPackage
    ({ mkDerivation, async, attoparsec, base, blaze-builder, bytestring
     ...
     mkDerivation {
       ...
       revision = "1";
       editedCabalFile = "0x56lx79ysbpy5lb4jziqw76176s37wprnxmqzvbl6bryfq9n065";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "file-location" = callPackage
    ({ mkDerivation, base, containers, lifted-base, process
     ...
     mkDerivation {
       pname = "file-location";
       version = "0.4.6";
       sha256 = "035xszjzhckcazanfvxkwfw2gv2mbw483rinr7ngaqripnl6m0bp";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "foreign-var" = callPackage
    ({ mkDerivation, base, stm, transformers }:
     mkDerivation {
       pname = "foreign-var";
       version = "0.0.0.1";
       sha256 = "0rv4kszwbxx4gzkqv7kygj31pcjmyacs33bq2imjl24bjgy8si49";
       revision = "1";
  ...
  "hmatrix" = callPackage
    ({ mkDerivation, array, base, binary, blas, bytestring, deepseq
     ...
     mkDerivation {
       ...
       revision = "1";
       editedCabalFile = "0s2ydc8wzdq9djsgr7l1yrdf50p5b8gg7nsm9axnff174kl1j15m";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "hspec-core" = callPackage
    ({ mkDerivation, ansi-terminal, async, base, deepseq
     ...
     mkDerivation {
       ...
       revision = "4";
       editedCabalFile = "1y63ikqn2ycpx6s1dgy4q4brscl4r00cny1n2wq7b3cbj6mlbsha";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "http-client" = callPackage
    ({ mkDerivation, array, async, base, base64-bytestring
     ...
     mkDerivation {
       pname = "http-client";
       version = "0.4.8.1";
       sha256 = "08dd730ix5j0y7jrzrb8d0i153g2jmvklj97npdizmqhwxjfwiis";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "json-autotype" = callPackage
    ({ mkDerivation, aeson, base, bytestring, containers, filepath
     ...
     mkDerivation {
       pname = "json-autotype";
       version = "0.2.5.8";
       sha256 = "1p6pkhi50a81c4ldkqpvs8m2gmz1h3ayxhfshyy1dl06nrbfc0i0";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "keter" = callPackage
    ({ mkDerivation, aeson, array, async, attoparsec, base
     ...
     mkDerivation {
       ...
       revision = "2";
       editedCabalFile = "0z2dis0a8gkc41r6h5qp9cm4dlizrm4k7zkkl0vaal4vdzv27hmw";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "monad-control" = callPackage
    ({ mkDerivation, base, transformers, transformers-base
     ...
     mkDerivation {
       pname = "monad-control";
       version = "0.3.3.1";
       sha256 = "02v4j0z92r1za8l5q87zmhns1lbnfqqg1cnfy4l4yf8y9d2l2g2z";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "persistent" = callPackage
    ({ mkDerivation, aeson, attoparsec, base, base64-bytestring
     ...
     mkDerivation {
       pname = "persistent";
       version = "2.1.1.7";
       sha256 = "1nj2nwjzg95k1xyhk31mpmyy0flw4hjjf8r0959i1x1makrfy32f";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "safecopy" = callPackage
    ({ mkDerivation, array, base, bytestring, cereal, containers
     , old-time, template-haskell, text, time, vector
     }:
     mkDerivation {
       pname = "safecopy";
       version = "0.8.4";
  ...
  "tar" = callPackage
    ({ mkDerivation, base, bytestring, directory, filepath, time }:
     mkDerivation {
       ...
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-f-old-time"
         "-fsmall_base" "-fsplitbase" "-f-test-hlint"
       ];
       libraryHaskellDepends = [
  ...
  "wai-extra" = callPackage
    ({ mkDerivation, ansi-terminal, base, base64-bytestring
     ...
     mkDerivation {
       pname = "wai-extra";
       version = "3.0.4.5";
       sha256 = "1d139jid65qf64607m79b6z5d8al888krypfpwzc7gbl1mlhyna4";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "warp" = callPackage
    ({ mkDerivation, array, async, auto-update, base, blaze-builder
     ...
     mkDerivation {
       ...
       revision = "1";
       editedCabalFile = "1a2s8xkhmwpbabb9g9z2dqibb0h5n87bs0dbja5skyml97f3fw3g";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
