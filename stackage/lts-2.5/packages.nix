# Generated by stackage2nix 0.5.0 from "/nix/store/5hv357jpjvwz6dk84fmcz1mj7agww772-stackage-lts/lts-2.5.yaml"
  ...
  "hspec-core" = callPackage
    ({ mkDerivation, ansi-terminal, async, base, deepseq
     ...
     mkDerivation {
       ...
       revision = "3";
       editedCabalFile = "0k1402my819dsikawlkd89qnddl170b80qbg16s8p6j9jlprqbap";
       libraryHaskellDepends = [
