# Generated by stackage2nix 0.6.0 from "/nix/store/hjyi9jjczpnkmjskxpdrx1bcjrxzm15a-stackage-lts/lts-2.9.yaml"
  ...
  "http-reverse-proxy" = callPackage
    ({ mkDerivation, async, base, blaze-builder, bytestring
     ...
     mkDerivation {
       ...
       revision = "1";
       editedCabalFile = "0h6ggjf7ay15563rmrk62sangjsqhbkns6f3ih1gfb83k892v0as";
       libraryHaskellDepends = [
  ...
  "linear" = callPackage
    ({ mkDerivation, adjunctions, base, base-orphans, binary, bytes
     ...
     mkDerivation {
       ...
       revision = "3";
       editedCabalFile = "0l9kpmdpw6vvcmlwj04bpzyyfrdhqf707jmzvzha8kmq91xmbqci";
       libraryHaskellDepends = [
  ...
  "pointed" = callPackage
    ({ mkDerivation, base, comonad, containers, data-default-class
     ...
     mkDerivation {
       ...
       revision = "1";
       editedCabalFile = "1xw4zaykg7jxmhwirl3va1gfwai4h77hda2lh23dxbvr8jvfj450";
       libraryHaskellDepends = [
  ...
  "warp" = callPackage
    ({ mkDerivation, array, async, auto-update, base, blaze-builder
     ...
     mkDerivation {
       ...
       revision = "1";
       editedCabalFile = "00gqnb2jz7wm1jzwfk32d7vc3zb8w2ww7iyyww2lq0jd1acgx8mp";
       libraryHaskellDepends = [
