# Generated by stackage2nix 0.6.1 from "/nix/store/jwic59nw202khsy06b5hy9irq3zipzb8-stackage-lts/lts-3.17.yaml"
  ...
  "hspec-core" = callPackage
    ({ mkDerivation, ansi-terminal, async, base, deepseq
     ...
     mkDerivation {
       ...
       revision = "4";
       editedCabalFile = "15pzddsd5m6dfy5jhz2m57avsbiyjdjv7q03h8mgxld9n2lvkbzj";
       libraryHaskellDepends = [
