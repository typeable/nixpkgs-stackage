# Generated by stackage2nix 0.5.0 from "/nix/store/5hv357jpjvwz6dk84fmcz1mj7agww772-stackage-lts/lts-1.8.yaml"
  ...
  "hspec-core" = callPackage
    ({ mkDerivation, ansi-terminal, async, base, deepseq
     ...
     mkDerivation {
       ...
       revision = "3";
       editedCabalFile = "10kmfkjbxd7l193s52kpa726zxq68s3f9ngf3m5vzq6gnxdqv0yi";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
