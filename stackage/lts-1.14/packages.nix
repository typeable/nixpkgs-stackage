# Generated by stackage2nix 0.5.0 from "/nix/store/5hv357jpjvwz6dk84fmcz1mj7agww772-stackage-lts/lts-1.14.yaml"
  ...
  "warp" = callPackage
    ({ mkDerivation, array, async, auto-update, base, blaze-builder
     ...
     mkDerivation {
       ...
       revision = "1";
       editedCabalFile = "1yy75pczwym27lvqmmsg8chgflkv6wcmnk8dshm3cdy3v8rpzcna";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
