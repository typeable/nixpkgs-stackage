# Generated by stackage2nix 0.5.0 from "/nix/store/5hv357jpjvwz6dk84fmcz1mj7agww772-stackage-lts/lts-2.19.yaml"
  ...
  "comonad" = callPackage
    ({ mkDerivation, base, containers, contravariant, directory
     ...
     mkDerivation {
       ...
       revision = "3";
       editedCabalFile = "0ixn3vazjq22mmf7xd40x7mp2aqimbm5wxwn40l692paqlrb10wp";
       libraryHaskellDepends = [
