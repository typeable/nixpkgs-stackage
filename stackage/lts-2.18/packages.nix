# Generated by stackage2nix 0.6.1 from "/nix/store/jwic59nw202khsy06b5hy9irq3zipzb8-stackage-lts/lts-2.18.yaml"
  ...
  "comonad" = callPackage
    ({ mkDerivation, base, containers, contravariant, directory
     ...
     mkDerivation {
       ...
       revision = "4";
       editedCabalFile = "1bvsaicfbij6mjm39im2xp1n9gqinsmqj7d3lx0bvf5g31vkvr99";
       libraryHaskellDepends = [
  ...
  "http-conduit" = callPackage
    ({ mkDerivation, base, blaze-builder, bytestring, case-insensitive
     ...
     mkDerivation {
       ...
       revision = "1";
       editedCabalFile = "0408hbl501iq254p3snkpf4fh3kflvhk3z69w5pl2brhh54pgcfd";
       libraryHaskellDepends = [
