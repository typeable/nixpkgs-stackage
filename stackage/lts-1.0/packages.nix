# Generated by stackage2nix 0.6.0 from "/nix/store/hjyi9jjczpnkmjskxpdrx1bcjrxzm15a-stackage-lts/lts-1.0.yaml"
...
self: {
    ...
    ({ mkDerivation, base }:
     mkDerivation {
       ...
       configureFlags = [
         ...
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
  ...
  "ChasingBottoms" = callPackage
    ({ mkDerivation, array, base, containers, mtl, QuickCheck, random
     ...
     mkDerivation {
       ...
       version = "1.3.0.9";
       sha256 = "14nxahs53j2bnqdyl331k76kmmisv78g7c29w9vq9c7r8ygrpnqc";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "JuicyPixels" = callPackage
    ({ mkDerivation, base, binary, bytestring, containers, deepseq, mtl
     ...
     mkDerivation {
       pname = "JuicyPixels";
       version = "3.2.1";
       sha256 = "0aq0km5dbrbwgk9ps461b9222xigc4f89jgvrss1yjni5m36x5rh";
       revision = "1";
  ...
  "Spock" = callPackage
    ({ mkDerivation, aeson, base, base64-bytestring, bytestring
     ...
     mkDerivation {
       ...
       revision = "1";
       editedCabalFile = "1156r85jzqid6vpgvmxr9kv0pcbpx5fvci5lcpqnrirzq4h3w6k0";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "cabal-install" = callPackage
    ({ mkDerivation, array, base, bytestring, Cabal, containers
     ...
     mkDerivation {
       pname = "cabal-install";
       version = "1.18.0.7";
       sha256 = "02fcjmxc10bri1iyxd7q7hzxgd44za29xrcfjlvx4vhiyf6gdq5h";
       revision = "1";
  ...
  "conduit-extra" = callPackage
    ({ mkDerivation, async, attoparsec, base, blaze-builder, bytestring
     ...
     mkDerivation {
       pname = "conduit-extra";
       version = "1.1.6";
       sha256 = "1q0a9b7c7r52x611zrm2h41500fz60c6mnilz2vj5f792bmrq9wr";
       revision = "2";
       editedCabalFile = "0ya73kzgzwf22m1d6fkwb46453mqs88q8m7x3vx9g74rxr3yavqa";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "constraints" = callPackage
    ({ mkDerivation, base, ghc-prim, newtype }:
     mkDerivation {
       pname = "constraints";
       version = "0.4.1.2";
       sha256 = "0c195hpnpn4xgd7y3c4bl4xhkc82ka16bw0g0yx5apvijc4cy4b7";
       revision = "2";
  ...
  "formatting" = callPackage
    ({ mkDerivation, base, old-locale, scientific, text, text-format
     ...
     mkDerivation {
       pname = "formatting";
       version = "6.0.0";
       sha256 = "01zighgfc8nywigzsah07fr7pkcz0mfrb495gikaapi01i13nkmc";
       revision = "1";
  ...
  "hasql-postgres" = callPackage
    ({ mkDerivation, attoparsec, base, base-prelude, bytestring, either
     , free, hashable, hashtables, hasql-backend, list-t, loch-th
     , mmorph, placeholders, postgresql-binary, postgresql-libpq
  ...
  "hmatrix" = callPackage
    ({ mkDerivation, array, base, binary, blas, bytestring, deepseq
     ...
     mkDerivation {
       ...
       revision = "1";
       editedCabalFile = "0mx6l1pqjc6bbk8864khljcdyy4d3yxw4wdr4v6rx3y6vrxzkxhz";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "hoauth2" = callPackage
    ({ mkDerivation, aeson, base, bytestring, bytestring-show
     , http-conduit, http-types, monad-control, mtl, random, text
     , transformers
     }:
     mkDerivation {
       pname = "hoauth2";
  ...
  "list-t" = callPackage
    ({ mkDerivation, base-prelude, mmorph, monad-control, transformers
     , transformers-base
     }:
     mkDerivation {
       pname = "list-t";
  ...
  "mersenne-random-pure64" = callPackage
    ({ mkDerivation, base, old-time, random }:
     mkDerivation {
       ...
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-f-small_base"
         "-fsplitbase" "-f-test-hlint"
       ];
  ...
  "monad-journal" = callPackage
    ({ mkDerivation, base, either, monad-control, mtl, transformers
     ...
     mkDerivation {
       pname = "monad-journal";
       version = "0.6.0.2";
       sha256 = "1lbvmc1192jvncza6mmbvz8szjgin6v0xmn80xlhsccjv4bkryx5";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
    ...
    ({ mkDerivation, aeson, base, bytestring, conduit, containers
     ...
     mkDerivation {
       ...
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-fsystemlib" "-f-test-hlint"
       ];
       isLibrary = true;
       isExecutable = true;
       libraryHaskellDepends = [
  ...
  "postgresql-binary" = callPackage
    ({ mkDerivation, attoparsec, base, base-prelude, bytestring
     , criterion, deepseq, loch-th, mtl-prelude, placeholders
  ...
  "shelly" = callPackage
    ({ mkDerivation, async, base, bytestring, containers, directory
     ...
     mkDerivation {
       pname = "shelly";
       version = "1.5.7";
       sha256 = "11ffp8rynyzmsll1izpc3kdzlyy0sx1m7syxn992rzpf7n970ivn";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "stackage" = callPackage
    ({ mkDerivation, aeson, async, base, bytestring, Cabal
     ...
     , http-client-tls, mono-traversable, mtl, old-locale, process
     ...
     mkDerivation {
       pname = "stackage";
       version = "0.3.1";
       sha256 = "1x4618asx2pwzk5g3alcjg535qybq3632a6w68wjkfwpl3dfcn91";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "storable-complex" = callPackage
    ({ mkDerivation, base }:
     mkDerivation {
       ...
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-f-instanceinbase" "-fnetwork-uri" "-fnew-base" "-fold-locale"
         "-fsmall_base" "-fsplitbase" "-f-test-hlint"
       ];
       libraryHaskellDepends = [ base ];
  ...
  "syb" = callPackage
    ({ mkDerivation, base, containers, HUnit, mtl }:
     mkDerivation {
       pname = "syb";
       version = "0.4.3";
       sha256 = "0d8f97gqwmzn61b294kpdd3ja8zcq11n0plx5wc3spf7jy8z97vl";
       revision = "1";
       editedCabalFile = "1a02s7inlbfnc498by6815vyl5mb7n5jwzbbfbgh0whxi2j74m6c";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "text" = callPackage
    ({ mkDerivation, array, base, bytestring, deepseq, directory
     ...
     mkDerivation {
       ...
       revision = "1";
       editedCabalFile = "06giwghzny54cnrlvcn2d5zjp3zy9wz7lw7662x248849y367l8s";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-f-integer-simple" "-fnetwork-uri" "-fnew-base" "-fold-locale"
         "-fsmall_base" "-fsplitbase" "-f-test-hlint"
       ];
       libraryHaskellDepends = [
  ...
  "wai-extra" = callPackage
    ({ mkDerivation, ansi-terminal, base, base64-bytestring
     ...
     mkDerivation {
       pname = "wai-extra";
       version = "3.0.3.2";
       sha256 = "0r7hyxzanxpndqnvyaax575hy45zwg2qaykqg914fmcy1azl9lyq";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "warp" = callPackage
    ({ mkDerivation, array, async, auto-update, base, blaze-builder
     ...
     mkDerivation {
       pname = "warp";
       version = "3.0.5";
       sha256 = "05rnjnvyn7yqrn7yq78ywj7kb1p4l2aq56003dpzc4a0d2zw24fp";
       revision = "1";
       editedCabalFile = "1w0cjzax84l75alj1r1jm964dwac8ymqpkmzy1w6744gldgx0snb";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
    ...
    ({ mkDerivation, aeson, aeson-qq, attoparsec, base, bytestring
     ...
     mkDerivation {
       ...
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-fsystem-libyaml" "-f-test-hlint"
       ];
       isLibrary = true;
       isExecutable = true;
       libraryHaskellDepends = [
  ...
  "yesod-auth" = callPackage
    ({ mkDerivation, aeson, authenticate, base, base16-bytestring
     ...
     mkDerivation {
       pname = "yesod-auth";
       version = "1.4.1.2";
       sha256 = "1islvp3dxfa6xmgm96hqa06vxrjhg98hd014rvbyqsx1gkn7xkq5";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "yesod-bin" = callPackage
    ({ mkDerivation, attoparsec, base, base64-bytestring, blaze-builder
     ...
     mkDerivation {
       pname = "yesod-bin";
       version = "1.4.3.2";
       sha256 = "04a6z312nf195y8xq8vr2j96hwya3bpqhndp1n0l99dyipp5cpk8";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
