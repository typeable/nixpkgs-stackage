# Generated by stackage2nix 0.6.0 from "/nix/store/hjyi9jjczpnkmjskxpdrx1bcjrxzm15a-stackage-lts/lts-1.11.yaml"
  ...
  "comonad" = callPackage
    ({ mkDerivation, base, containers, contravariant, directory
     ...
     mkDerivation {
       ...
       revision = "1";
       editedCabalFile = "17f7hm5f1bgsyzsnf3k3kfp46whc5xzgavrsnkf03735vhdrywnd";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
  ...
  "contravariant" = callPackage
    ({ mkDerivation, base, foreign-var, semigroups, transformers
     ...
     mkDerivation {
       pname = "contravariant";
       version = "1.2.2";
       sha256 = "1f0g6iaiwrlq03vl84dvxpv8sqn519axdsfh1j0gjlyfdw245yg5";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
