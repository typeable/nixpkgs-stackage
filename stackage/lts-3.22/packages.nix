# Generated by stackage2nix 0.6.0 from "/nix/store/hjyi9jjczpnkmjskxpdrx1bcjrxzm15a-stackage-lts/lts-3.22.yaml"
  ...
  "tagsoup" = callPackage
    ({ mkDerivation, base, bytestring, containers, text }:
     mkDerivation {
       pname = "tagsoup";
       version = "0.13.7";
       sha256 = "0dvd6rkidz825g7zisyzhq7m6wz6mfhk1zzw7fpz51p6886jxmvg";
       isLibrary = true;
       isExecutable = true;
       libraryHaskellDepends = [ base bytestring containers text ];
  ...
  "yesod-auth-oauth2" = callPackage
    ({ mkDerivation, aeson, authenticate, base, bytestring, hoauth2
     ...
     mkDerivation {
       ...
       version = "0.1.6";
       sha256 = "0lyvzn9k1h3s76731n178kx8ac56vaighxbkdn4dbn5676b6443g";
       libraryHaskellDepends = [
