# Generated by stackage2nix 0.6.0 from "/nix/store/hjyi9jjczpnkmjskxpdrx1bcjrxzm15a-stackage-lts/lts-2.10.yaml"
  ...
  "jmacro" = callPackage
    ({ mkDerivation, aeson, base, bytestring, containers
     ...
     mkDerivation {
       ...
       revision = "1";
       editedCabalFile = "1lf9saxcai78jfw6b43v7zfsvhhbqvf32wvs4lyx4br23dnsb6jy";
       isLibrary = true;
       isExecutable = true;
       libraryHaskellDepends = [
