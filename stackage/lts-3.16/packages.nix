# Generated by stackage2nix 0.5.0 from "/nix/store/5hv357jpjvwz6dk84fmcz1mj7agww772-stackage-lts/lts-3.16.yaml"
  ...
  "HTTP" = callPackage
    ({ mkDerivation, array, base, bytestring, mtl, network, network-uri
     ...
     mkDerivation {
       pname = "HTTP";
       version = "4000.2.21";
       sha256 = "14dxgf9kc5sj4si8kcxzfi70znki1jp3dfc9hwclmgf9sivha1pw";
       libraryHaskellDepends = [
  ...
  "alex" = callPackage
    ({ mkDerivation, array, base, containers, directory, happy, process
     ...
     mkDerivation {
       pname = "alex";
       version = "3.1.5";
       sha256 = "041215ii29dfrvkgcavicxir7439mppwwhx9h9s6gmf28rjv1bfx";
       isLibrary = false;
       isExecutable = true;
       executableHaskellDepends = [
