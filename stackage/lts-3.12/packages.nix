# Generated by stackage2nix 0.5.0 from "/nix/store/5hv357jpjvwz6dk84fmcz1mj7agww772-stackage-lts/lts-3.12.yaml"
  ...
  "purescript" = callPackage
    ({ mkDerivation, aeson, aeson-better-errors, ansi-wl-pprint, base
     ...
     mkDerivation {
       pname = "purescript";
       version = "0.7.5.3";
       sha256 = "195ld17q2hs28rlcj52vn1idybh6hqgrpdbi9h8m18sc9l70323k";
       isLibrary = true;
       isExecutable = true;
       libraryHaskellDepends = [
