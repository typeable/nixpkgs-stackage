# Generated by stackage2nix 0.6.1 from "/nix/store/jwic59nw202khsy06b5hy9irq3zipzb8-stackage-lts/lts-2.6.yaml"
  ...
  "network-uri" = callPackage
    ({ mkDerivation, base, deepseq, HUnit, parsec, test-framework
     ...
     mkDerivation {
       pname = "network-uri";
       version = "2.6.0.2";
       sha256 = "0mshka8200s96iqd068ygbcpbp0c84z4vgjqymw1ck05k67vzljm";
