# Generated by stackage2nix 0.5.0 from "/nix/store/5hv357jpjvwz6dk84fmcz1mj7agww772-stackage-lts/lts-1.13.yaml"
  ...
  "comonad" = callPackage
    ({ mkDerivation, base, containers, contravariant, directory
     ...
     mkDerivation {
       ...
       revision = "1";
       editedCabalFile = "1mzvhnn1jr0vwk53h18r84sm1mn6988arz0wjffy9323ams5fjz9";
       configureFlags = [
         "-fblaze_html_0_5" "-f-bytestring-in-base" "-fhttps"
         "-fnetwork-uri" "-fnew-base" "-fold-locale" "-fsmall_base"
         "-fsplitbase" "-f-test-hlint"
